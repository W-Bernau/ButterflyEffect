...
function initPhysics() {
    ...
    circ3.radius = radPhys;
    circ4.radius = radPhys;
}
...
function draw() {
    ...
    ctx.globalCompositeOperation = 'destination-over';
    ctx.lineWidth = lineWidthPhys / physicsScale;
...
var settings = {
    ...
    apply:function() {
        ...
        dTheta1 = 0;
        dTheta2 = 0;
        radPhys = this.radPhys;
        lineWidthPhys=this.lineWidthPhys;
...
gui.add(settings, 'length1', 10, 200);
gui.add(settings, 'length2', 10, 200);
gui.add(settings, 'mass1', 1, 30);
gui.add(settings, 'mass2', 1, 30);
